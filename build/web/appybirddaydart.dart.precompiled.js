...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["", "appybirddaydart.dart", , Q, {
  "^": "",
  debugOut: function(deb) {
    var out = document.createElement("div", null);
    out.textContent = deb;
    J.get$children$x(document.querySelector("#debugOut")).add$1(0, out);
  },
  sizePrompt: function(value) {
    var numval, modelSizes, t1, ord, closest;
    numval = H.Primitives_parseInt(value, null, null);
    modelSizes = H.fillLiteralMap(["Sunbird", 10, "Sparrow", 15, "Bulbul", 20, "Myna", 23, "Crow", 43, "Kite", 61, "Vulture", 91], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    t1 = modelSizes.get$keys();
    ord = P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0));
    H.Sort__doSort(ord, 0, ord.length - 1, new Q.sizePrompt_closure(numval, modelSizes));
    if (0 >= ord.length)
      return H.ioore(ord, 0);
    closest = ord[0];
    return "  " + H.S(value) + " cm (~ " + H.S(closest) + "=" + H.S(modelSizes.$index(0, closest)) + "cm)";
  },
  sizeInput: function(features, rep) {
    var $prompt, slider, t1, t2, txtsz, span;
    $prompt = document.createElement("p", null);
    $prompt.textContent = Q.sizePrompt("25");
    if (features.features.containsKey$1("size") && features.features.$index(0, "size").containsKey$1("size") === true)
      $prompt.textContent = Q.sizePrompt(J.$index$asx(features.features.$index(0, "size"), "size"));
    slider = W.InputElement_InputElement("range");
    t1 = J.getInterceptor$x(slider);
    t1.set$min(slider, "0");
    t1.set$max(slider, "120");
    t1.set$value(slider, "25");
    if (features.features.containsKey$1("size") && features.features.$index(0, "size").containsKey$1("size") === true)
      t1.set$value(slider, J.$index$asx(features.features.$index(0, "size"), "size"));
    t2 = t1.get$onChange(slider);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.sizeInput_closure(features, rep, $prompt, slider)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    txtsz = W.InputElement_InputElement("text");
    txtsz.textContent = "size: ";
    t2 = J.getInterceptor$x(txtsz);
    t2.get$classes(txtsz).add$1(0, "sizetextinp");
    t2.set$size(txtsz, 2);
    t2 = t2.get$onChange(txtsz);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.sizeInput_closure0(features, rep, $prompt, slider, txtsz)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t1.get$children(slider).add$1(0, txtsz);
    span = document.createElement("span", null);
    J.set$children$x(span, [$prompt, slider]);
    return span;
  },
  binMatch: function(group, attr, rep, desc) {
    if (rep.features.containsKey$1(group) && rep.features.$index(0, group).containsKey$1(attr) === true && desc.has$2(group, attr) && J.toLowerCase$0$s(J.$index$asx(rep.features.$index(0, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "true")
      return $.binSeen;
    else
      return 0;
  },
  behMatch: function(group, attr, rep, desc) {
    if (rep.features.containsKey$1(group) && rep.features.$index(0, group).containsKey$1(attr) === true && desc.has$2(group, attr)) {
      if (J.toLowerCase$0$s(J.$index$asx(rep.features.$index(0, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "often")
        return $.behCommonSeen;
      if (J.toLowerCase$0$s(J.$index$asx(rep.features.$index(0, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "rarely")
        return $.behRareSeen;
    }
    return 0;
  },
  colMatchSum: function(rep, desc) {
    var t1, sum, group, t2, t3, t4, t5;
    for (t1 = new H.ListIterator($.get$mainColours(), 3, 0, null), sum = 0; t1.moveNext$0();) {
      group = t1._current;
      if (rep.features.containsKey$1(group) && rep.features.$index(0, group).containsKey$1("colour") === true && desc.has$2(group, "colour")) {
        t2 = $.colWt;
        t3 = $.colPar;
        t4 = J.$index$asx(rep.features.$index(0, group), "colour");
        t5 = desc.get$2(group, "colour");
        t5 = t2 * (t3 - Q.RGB$fromString(t4).colDiff$1(Q.RGB$fromString(t5)));
        t2 = t5;
      } else
        t2 = 0;
      sum += t2;
    }
    for (t1 = new H.ListIterator($.get$otherColours(), 6, 0, null); t1.moveNext$0();) {
      group = t1._current;
      if (rep.features.containsKey$1(group) && rep.features.$index(0, group).containsKey$1("colour") === true && desc.has$2(group, "colour")) {
        t2 = $.colWt;
        t3 = $.colPar;
  ...
  behMatchSum: function(rep, desc) {
    var t1, t2, sum, group, t3;
    for (t1 = $.get$behAttr().get$keys()._map, t2 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first, sum = 0; t2.moveNext$0();) {
      group = t2._collection$_current;
      for (t1 = $.get$behAttr().$index(0, group), t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        t3 = Q.behMatch(group, t1._current, rep, desc);
        if (typeof t3 !== "number")
          return H.iae(t3);
        sum += t3;
      }
    }
    Q.debugOut(C.JSInt_methods.toString$0(sum));
    return sum;
  },
  binMatchSum: function(rep, desc) {
    var t1, t2, sum, group;
    for (t1 = $.get$binAttr().get$keys()._map, t2 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first, sum = 0; t2.moveNext$0();) {
      group = t2._collection$_current;
      for (t1 = $.get$binAttr().$index(0, group), t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        sum += Q.binMatch(group, t1._current, rep, desc);
    }
    Q.debugOut(C.JSInt_methods.toString$0(sum));
    return sum;
  },
  checkboxChoose: function(group, $name, features, rep) {
    var item, par, inp, t1;
    item = document.createElement("li", null);
    par = document.createElement("p", null);
    par.textContent = $name;
    inp = W.InputElement_InputElement("checkbox");
    if (features.features.containsKey$1(group) && features.features.$index(0, group).containsKey$1($name) === true)
      J.set$value$x(inp, J.$index$asx(features.features.$index(0, group), $name));
    t1 = J.get$onChange$x(inp);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.checkboxChoose_closure(group, $name, features, rep, inp)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.get$children$x(par).add$1(0, inp);
    J.get$children$x(item).add$1(0, par);
    return item;
  },
  colourChoose: function($name, features, rep) {
    var item, par, inp, t1;
    item = document.createElement("li", null);
    par = document.createElement("p", null);
    par.textContent = $name;
    inp = W.InputElement_InputElement(null);
    if (features.features.containsKey$1("colour") && features.features.$index(0, "colour").containsKey$1($name) === true)
      J.set$value$x(inp, J.$index$asx(features.features.$index(0, "colour"), $name));
    t1 = J.getInterceptor$x(inp);
    t1.set$type(inp, "color");
    t1 = t1.get$onChange(inp);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.colourChoose_closure($name, features, rep, inp)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.get$children$x(par).add$1(0, inp);
    J.get$children$x(item).add$1(0, par);
    return item;
  },
  checkboxList: function(group, names, features, rep) {
    var ulist = document.createElement("ul", null);
    names.toString;
    H.IterableMixinWorkaround_forEach(names, new Q.checkboxList_closure(group, features, rep, ulist));
    return ulist;
  },
  repUpdate: function() {
    document.querySelector("#rep").textContent = $.get$reported().features.toString$0(0) + "\n" + $.get$descrips().display$0();
    var bestBirds = J.take$1$ax($.get$birdIds(), 12);
    J.set$children$x(document.querySelector("#best"), H.setRuntimeTypeInfo(new H.MappedListIterable(bestBirds, Q.birdBox$closure()), [null, null]).toList$0(0));
  },
  colourquerySelector: function(colours, features, rep) {
    return H.setRuntimeTypeInfo(new H.MappedListIterable(colours, new Q.colourquerySelector_closure(features, rep)), [null, null]).toList$0(0);
  },
  birdBox: [function(bird) {
    var e, t1, anchor, div;
    e = document.createElement("img", null);
    t1 = J.getInterceptor$x(e);
    t1.set$src(e, "http:" + H.S(J.get$img$x(bird)));
    t1.set$height(e, 100);
    t1.set$width(e, 100);
    t1.get$classes(e).add$1(0, "leftmargin");
    anchor = W.AnchorElement_AnchorElement(null);
    t1 = J.getInterceptor$x(anchor);
    t1.set$href(anchor, "http://en.wikipedia.org" + H.S(bird.url));
    anchor.textContent = bird.name;
    t1.set$target(anchor, "_blank");
    t1.get$classes(anchor).add$1(0, "leftmargin");
    div = document.createElement("div", null);
    J.set$children$x(div, [e, document.createElement("p", null), anchor, W._ElementFactoryProvider_createElement_tag("hr", null)]);
    return div;
  }, "call$1", "birdBox$closure", 2, 0, 1],
  binAttributes: function(features, rep) {
    J.set$children$x(document.querySelector("#bin_attr"), []);
    $.get$binAttr().get$keys().forEach$1(0, new Q.binAttributes_closure(features, rep));
  },
  behAttributes: function(features, rep) {
    J.set$children$x(document.querySelector("#beh_attr"), []);
    $.get$behAttr().get$keys().forEach$1(0, new Q.behAttributes_closure(features, rep));
  },
  behDescAttributes: function(features) {
    J.set$children$x(document.querySelector("#beh_attr"), []);
    $.get$behAttr().get$keys().forEach$1(0, new Q.behDescAttributes_closure(features));
  },
  repQueries: function() {
    var updateButton, t1, bestBirds;
    Q.debugOut($.get$descrips().display$0());
    document.querySelector("#subt").textContent = "Select prominent features that you have observed. The software guesses based on how well these match with the description.";
    J.set$children$x(document.querySelector("#size"), [Q.sizeInput($.get$reported(), true)]);
    J.set$children$x(document.querySelector("#colour_list"), Q.colourquerySelector($.get$mainColours(), $.get$reported(), true));
    J.set$children$x(document.querySelector("#other_colour_list"), Q.colourquerySelector($.get$otherColours(), $.get$reported(), true));
    Q.binAttributes($.get$reported(), true);
    Q.behAttributes($.get$reported(), true);
    updateButton = document.createElement("button", null);
    updateButton.textContent = "Contribute descriptions to the database";
    t1 = J.getInterceptor$x(updateButton);
    t1.get$classes(updateButton).add$1(0, "button");
    t1 = t1.get$onClick(updateButton);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.repQueries_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$children$x(document.querySelector("#topbar"), [updateButton]);
    bestBirds = J.take$1$ax($.get$birdIds(), 12);
    J.set$children$x(document.querySelector("#best"), H.setRuntimeTypeInfo(new H.MappedListIterable(bestBirds, Q.birdBox$closure()), [null, null]).toList$0(0));
    document.querySelector("#besthead").textContent = "Best Matches";
    document.querySelector("#resthead").textContent = "";
    document.querySelector("#searchhead").textContent = "";
    J.set$children$x(document.querySelector("#searchbox"), []);
    J.set$children$x(document.querySelector("#rest"), []);
    J.set$children$x(document.querySelector("#queryfoot"), []);
  },
  descQueries: function(features) {
    var identButton, t1, morph, morphInput, submitButton;
    document.querySelector("#subt").textContent = "Select prominent features of the bird. You need not describe features that are unlikely to be noticed.";
    J.set$children$x(document.querySelector("#size"), [Q.sizeInput(features, false)]);
    J.set$children$x(document.querySelector("#colour_list"), Q.colourquerySelector($.get$mainColours(), features, false));
    J.set$children$x(document.querySelector("#other_colour_list"), Q.colourquerySelector($.get$otherColours(), features, false));
    Q.binAttributes(features, false);
    Q.behDescAttributes(features);
    identButton = document.createElement("button", null);
    identButton.textContent = "Return to Bird identification";
    t1 = J.getInterceptor$x(identButton);
    t1.get$classes(identButton).add$1(0, "button");
    t1 = t1.get$onClick(identButton);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.descQueries_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$children$x(document.querySelector("#topbar"), [identButton]);
    morph = document.createElement("span", null);
    morph.textContent = "Morph";
    J.get$classes$x(morph).add$1(0, "inp");
    morphInput = W.InputElement_InputElement(null);
    morphInput.textContent = "morph";
    t1 = J.getInterceptor$x(morphInput);
    t1.set$size(morphInput, 10);
    t1.get$classes(morphInput).add$1(0, "inp");
    t1 = t1.get$onChange(morphInput);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.descQueries_closure0(morphInput)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    t1.get$classes(submitButton).add$1(0, "input");
    t1 = t1.get$onClick(submitButton);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.descQueries_closure1(features)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$children$x(document.querySelector("#queryfoot"), [morph, morphInput, submitButton]);
  },
  birdChooseList: function(birdlst, fullbirdlist, features) {
    var div = document.createElement("div", null);
    H.SubListIterable$(birdlst, 0, 15, null).forEach$1(0, new Q.birdChooseList_closure(fullbirdlist, features, div));
    return div;
  },
  birdBar: function(firstbird, birdlist, fullbirdlist, features) {
    var t1, inp, t2;
    t1 = {};
    t1.features_0 = features;
    if ($.get$descrips().descs.containsKey$1(firstbird)) {
      features = new Q.Features(null);
      features.features = $.get$descrips().descs.$index(0, firstbird).get$features();
      t1.features_0 = features;
      Q.descQueries(features);
    }
    $.birdChosen = firstbird;
    inp = W.InputElement_InputElement(null);
    inp.textContent = "search:";
    t2 = J.getInterceptor$x(inp);
    t2.set$type(inp, "search");
    t1.brdList_1 = Q.birdChooseList(birdlist, fullbirdlist, t1.features_0);
    t2 = t2.get$onInput(inp);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.birdBar_closure(t1, fullbirdlist, inp)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    document.querySelector("#besthead").textContent = "Describe";
    J.set$children$x(document.querySelector("#best"), [Q.birdBox($.birdChosen)]);
    document.querySelector("#resthead").textContent = "Choose bird to describe";
    document.querySelector("#searchhead").textContent = "Name";
    J.set$children$x(document.querySelector("#searchbox"), [inp]);
    J.set$children$x(document.querySelector("#rest"), [t1.brdList_1]);
  },
  descInput: function(birds) {
    var t1, bestbirds;
    t1 = new Q.Features(null);
    t1.features = H.fillLiteralMap(["size", H.fillLiteralMap(["size", "25"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    $.descFeatures = t1;
    Q.descQueries(t1);
    t1 = J.where$1$ax(birds, new Q.descInput_closure());
    bestbirds = P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0));
    if (0 >= bestbirds.length)
      return H.ioore(bestbirds, 0);
    Q.birdBar(bestbirds[0], bestbirds, birds, $.get$descFeatures());
  },
  getBird: function(d) {
    var t1, t2, morph;
    t1 = {};
    t2 = J.getInterceptor$asx(d);
    t1.brd_0 = new Q.BirdId(t2.$index(d, "name"), t2.$index(d, "sci"), t2.$index(d, "url"), t2.$index(d, "img"), "");
    morph = d.containsKey$1("morph") === true ? t2.$index(d, "morph") : "";
    J.forEach$1$ax($.get$birdIds(), new Q.getBird_closure(t1, d, morph));
    return t1.brd_0;
  },
  putDesc: function(b, desc) {
    var idMap = H.fillLiteralMap(["name", J.get$name$x(b), "sci", b.get$sci(), "url", b.url, "img", b.img, "morph", b.morph], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    desc.features.get$keys().forEach$1(0, new Q.putDesc_closure(desc, idMap));
  },
  updateDesc: function(b, desc) {
    return W.HttpRequest_postFormData("../birdRemove", H.fillLiteralMap(["sci", b.get$sci(), "morph", b.morph], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), null, null, null, null).then$1(new Q.updateDesc_closure(b, desc));
  },
  matchBird: function(birdId, rep) {
    var t1, t2, t3, t4, t5, t6, out;
    if ($.get$descrips().descs.containsKey$1(birdId))
      Q.debugOut(J.get$name$x(birdId));
    if ($.get$descrips().descs.containsKey$1(birdId)) {
      t1 = $.get$descrips().descs.$index(0, birdId);
      t2 = Q.binMatchSum(rep, t1);
      t3 = Q.behMatchSum(rep, t1);
      t4 = Q.colMatchSum(rep, t1);
      t5 = $.sizeExactMatch;
      if (t1.has$2("size", "size")) {
        t1 = H.Primitives_parseInt(J.$index$asx(t1.features.$index(0, "size"), "size"), null, null);
        t6 = H.Primitives_parseInt(J.$index$asx(rep.features.$index(0, "size"), "size"), null, null);
        if (typeof t1 !== "number")
          return t1.$div();
        if (typeof t6 !== "number")
          return H.iae(t6);
        t1 = Math.abs(Math.log(t1 / t6));
        t6 = $.sizeWt;
        if (typeof t6 !== "number")
          return H.iae(t6);
        t6 = t1 * t6;
      ...
      out = t5 + t1;
      Q.debugOut(C.JSNumber_methods.toString$0(out));
      t1 = birdId.get$sci();
      if ($.get$birdrace().containsKey$1(t1) === true) {
        t1 = J.$index$asx($.get$birdrace(), t1);
        if (typeof t1 !== "number")
          return H.iae(t1);
        t1 = 1 + t1;
      } else
  ...
  birdSort: function(features) {
    return J.sort$1$ax($.get$birdIds(), new Q.birdSort_closure(features));
  },
  main: [function() {
    if (!$.local)
      W.HttpRequest_getString("../abundances", null, null).then$1(new Q.main_closure()).then$1(new Q.main_closure0());
    else
      Q.repQueries();
  }, "call$0", "main$closure", 0, 0, 2],
  Features: {
    "^": "Object;features<",
    add$3: function(_, group, attr, value) {
      var t1, t2;
      t1 = this.features.containsKey$1(group);
      t2 = this.features;
      if (t1)
        J.$indexSet$ax(t2.$index(0, group), attr, value);
      else {
        t2.$indexSet(0, group, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        J.$indexSet$ax(this.features.$index(0, group), attr, value);
      }
    },
    get$2: function(group, attr) {
      return J.$index$asx(this.features.$index(0, group), attr);
    },
    has$2: function(group, attr) {
      return this.features.containsKey$1(group) && this.features.$index(0, group).containsKey$1(attr) === true;
    }
  },
  Descriptions: {
    "^": "Object;descs",
    display$0: function() {
      ...
      t1.dsp_0 = "{";
      t2 = this.descs;
      H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(t2), [H.getTypeArgumentByIndex(t2, 0)]).forEach$1(0, new Q.Descriptions_display_closure(t1, this));
      return t1.dsp_0 + "}";
    }
  },
  Descriptions_display_closure: {
    "^": "Closure:14;box_0,this_1",
    call$1: function(birdId) {
      var t1, dsp;
      t1 = this.box_0;
      dsp = t1.dsp_0 + (H.S(J.get$name$x(birdId)) + " : " + this.this_1.descs.$index(0, birdId).get$features().toString$0(0) + ", ");
      t1.dsp_0 = dsp;
      return dsp;
    }
  },
  BirdId: {
    "^": "Object;name>,sci<,url,img>,morph?",
    BirdId$fromMap$1: function(bird) {
      var t1 = J.getInterceptor$asx(bird);
      this.name = t1.$index(bird, "name");
      this.sci = t1.$index(bird, "sci");
      this.url = t1.$index(bird, "url");
      this.img = t1.$index(bird, "img");
    },
    static: {BirdId$fromMap: function(bird) {
        var t1 = new Q.BirdId(null, null, null, null, "");
        t1.BirdId$fromMap$1(bird);
        return t1;
      }}
  },
  sizePrompt_closure: {
    "^": "Closure:13;numval_0,modelSizes_1",
    call$2: function(x, y) {
      var t1, t2, t3;
      t1 = this.modelSizes_1;
      t2 = t1.$index(0, x);
      t3 = this.numval_0;
      if (typeof t2 !== "number")
        return t2.$sub();
      ...
      if (typeof t1 !== "number")
        return t1.$sub();
      return C.JSNumber_methods.compareTo$1(t2, Math.abs(t1 - t3));
    }
  },
  sizeInput_closure: {
    "^": "Closure:16;features_0,rep_1,prompt_2,slider_3",
    call$1: function($event) {
      var size, t1;
      size = J.get$value$x(this.slider_3);
      this.prompt_2.textContent = Q.sizePrompt(size);
      t1 = this.features_0;
      t1.add$3(0, "size", "size", size);
      if (this.rep_1) {
        Q.birdSort(t1);
        Q.repUpdate();
      }
  ...
  sizeInput_closure0: {
    "^": "Closure:16;features_4,rep_5,prompt_6,slider_7,txtsz_8",
    call$1: function($event) {
      var size, t1;
      size = J.get$value$x(this.txtsz_8);
      J.set$value$x(this.slider_7, size);
      this.prompt_6.textContent = Q.sizePrompt(size);
      t1 = this.features_4;
      t1.add$3(0, "size", "size", size);
      if (this.rep_5) {
        Q.birdSort(t1);
  ...
  RGB: {
    ...
    colDiff$1: function(that) {
      ...
      if (typeof t6 !== "number")
        return H.iae(t6);
      t6 = Math.abs(2 * t1 - t2 - t3 - (2 * t4 - t5 - t6));
      t5 = this.G;
      if (typeof t5 !== "number")
        return H.iae(t5);
      t4 = this.R;
      ...
      if (typeof t7 !== "number")
        return H.iae(t7);
      t7 = Math.abs(2 * t5 - t4 - t3 - (2 * t2 - t1 - t7));
      t1 = this.B;
      if (typeof t1 !== "number")
        return H.iae(t1);
      t2 = this.G;
      ...
      if (typeof t8 !== "number")
        return H.iae(t8);
      return (t6 + t7 + Math.abs(2 * t1 - t2 - t3 - (2 * t4 - t5 - t8)) + J.abs$0$n(J.$sub$n(J.$add$ns(J.$add$ns(this.R, this.G), this.B), J.$add$ns(J.$add$ns(that.R, that.G), that.B)))) / 750;
    },
    RGB$fromString$1: function(col) {
      this.R = H.Primitives_parseInt("0x" + J.getInterceptor$s(col).substring$2(col, 1, 3), null, null);
      this.G = H.Primitives_parseInt("0x" + C.JSString_methods.substring$2(col, 3, 5), null, null);
      this.B = H.Primitives_parseInt("0x" + C.JSString_methods.substring$2(col, 5, 7), null, null);
    },
    static: {RGB$fromString: function(col) {
        var t1 = new Q.RGB(null, null, null);
        t1.RGB$fromString$1(col);
        return t1;
      }}
  },
  checkboxChoose_closure: {
    "^": "Closure:16;group_0,name_1,features_2,rep_3,inp_4",
    call$1: function(e) {
      var value, t1;
      value = J.get$checked$x(this.inp_4) === true ? "true" : "false";
      t1 = this.features_2;
      t1.add$3(0, this.group_0, this.name_1, value);
      if (this.rep_3) {
        Q.birdSort(t1);
        Q.repUpdate();
      }
  ...
  colourChoose_closure: {
    "^": "Closure:16;name_0,features_1,rep_2,inp_3",
    call$1: function(e) {
      var t1 = this.features_1;
      t1.add$3(0, "colour", this.name_0, J.get$value$x(this.inp_3));
      if (this.rep_2) {
        Q.birdSort(t1);
        Q.repUpdate();
      }
  ...
  checkboxList_closure: {
    "^": "Closure:0;group_0,features_1,rep_2,ulist_3",
    call$1: function($name) {
      J.get$children$x(this.ulist_3).add$1(0, Q.checkboxChoose(this.group_0, $name, this.features_1, this.rep_2));
    }
  },
  colourquerySelector_closure: {
    "^": "Closure:0;features_0,rep_1",
    call$1: function(col) {
      return Q.colourChoose(col, this.features_0, this.rep_1);
    }
  },
  binAttributes_closure: {
    "^": "Closure:0;features_0,rep_1",
    call$1: function(group) {
      var div, t1;
      div = document.createElement("div", null);
      t1 = J.getInterceptor$x(div);
      t1.set$innerHtml(div, "<h3>" + H.S(group) + "</h3>");
      t1.get$children(div).add$1(0, Q.checkboxList(group, $.get$binAttr().$index(0, group), this.features_0, this.rep_1));
      J.get$children$x(document.querySelector("#bin_attr")).add$1(0, div);
    }
  },
  behAttributes_closure: {
    "^": "Closure:0;features_0,rep_1",
    call$1: function(group) {
      var div, t1;
      div = document.createElement("div", null);
      t1 = J.getInterceptor$x(div);
      t1.set$innerHtml(div, "<h3>" + H.S(group) + "</h3>");
      t1.get$children(div).add$1(0, Q.checkboxList(group, $.get$behAttr().$index(0, group), this.features_0, this.rep_1));
      J.get$children$x(document.querySelector("#beh_attr")).add$1(0, div);
    }
  },
  behDescAttributes_closure: {
    "^": "Closure:0;features_0",
    call$1: function(group) {
      var ul, div, t1;
      ...
      t1 = J.getInterceptor$x(div);
      t1.set$innerHtml(div, "<h3>" + H.S(group) + ":</h3>");
      t1.get$children(div).add$1(0, ul);
      t1 = $.get$behAttr().$index(0, group);
      t1.toString;
      H.IterableMixinWorkaround_forEach(t1, new Q.behDescAttributes__closure(this.features_0, group, ul));
      J.get$children$x(document.querySelector("#beh_attr")).add$1(0, div);
    }
  },
  behDescAttributes__closure: {
    "^": "Closure:14;features_1,group_2,ul_3",
    call$1: function(attr) {
      var $prompt, choiceButtons, li;
      $prompt = document.createElement("span", null);
      $prompt.textContent = H.S(attr);
      choiceButtons = document.createElement("ul", null);
      li = document.createElement("li", null);
      J.set$children$x(li, [$prompt, choiceButtons, document.createElement("p", null)]);
      J.get$children$x(this.ul_3).add$1(0, li);
      H.IterableMixinWorkaround_forEach(["often", "sometimes", "rarely"], new Q.behDescAttributes___closure(this.features_1, this.group_2, attr, choiceButtons));
    }
  },
  behDescAttributes___closure: {
    "^": "Closure:14;features_4,group_5,attr_6,choiceButtons_7",
    call$1: function(choice) {
      var button, t1, t2, t3, choicePrompt;
      button = W.InputElement_InputElement("radio");
      t1 = this.group_5;
      t2 = this.attr_6;
      t3 = J.getInterceptor$x(button);
      t3.set$name(button, J.$add$ns(J.$add$ns(t1, ":"), t2));
      t3.set$value(button, choice);
      t3 = t3.get$onClick(button);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new Q.behDescAttributes____closure(this.features_4, t1, t2, choice)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      choicePrompt = document.createElement("li", null);
      choicePrompt.textContent = choice;
      J.get$children$x(choicePrompt).add$1(0, button);
      J.get$children$x(this.choiceButtons_7).add$1(0, choicePrompt);
    }
  },
  behDescAttributes____closure: {
    "^": "Closure:14;features_8,group_9,attr_10,choice_11",
    call$1: function(e) {
      return this.features_8.add$3(0, this.group_9, this.attr_10, this.choice_11);
    }
  },
  repQueries_closure: {
    "^": "Closure:14;",
    call$1: function(e) {
      return Q.descInput($.get$birdIds());
    }
  },
  descQueries_closure: {
    "^": "Closure:14;",
  ...
  descQueries_closure0: {
    "^": "Closure:14;morphInput_0",
    call$1: function(e) {
      var t1, t2;
      t1 = $.birdChosen;
      t2 = J.get$value$x(this.morphInput_0);
      t1.set$morph(t2);
      return t2;
    }
  },
  descQueries_closure1: {
    "^": "Closure:14;features_1",
    call$1: function(e) {
      var t1, t2, t3;
      t1 = this.features_1;
      t2 = $.get$descrips();
      t3 = $.birdChosen;
      t2.descs.$indexSet(0, t3, t1);
      if (!$.local)
        Q.updateDesc($.birdChosen, t1);
      document.querySelector("#descs").textContent = $.get$descrips().display$0();
      Q.descInput($.get$birdIds());
      return;
    }
  },
  birdChooseList_closure: {
    "^": "Closure:14;fullbirdlist_0,features_1,div_2",
    call$1: function(b) {
      var el, t1;
      el = document.createElement("p", null);
      el.textContent = J.get$name$x(b);
      t1 = J.getInterceptor$x(el);
      t1.get$classes(el).add$1(0, "birdchoice");
      t1 = t1.get$onClick(el);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.birdChooseList__closure(this.fullbirdlist_0, this.features_1, b)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      J.get$children$x(this.div_2).add$1(0, el);
    }
  },
  birdChooseList__closure: {
    "^": "Closure:14;fullbirdlist_3,features_4,b_5",
    call$1: function(e) {
      var t1 = this.fullbirdlist_3;
      Q.birdBar(this.b_5, J.take$1$ax(t1, 15).toList$0(0), t1, this.features_4);
    }
  },
  birdBar_closure: {
    "^": "Closure:14;box_0,fullbirdlist_1,inp_2",
    call$1: function(e) {
      var t1, t2, t3, filterlist, t4, t5;
      t1 = this.inp_2;
      t2 = J.getInterceptor$x(t1);
      t3 = this.fullbirdlist_1;
      if (J.$eq(t2.get$value(t1), ""))
        filterlist = J.where$1$ax(t3, new Q.birdBar__closure());
      else {
        t4 = J.where$1$ax(t3, new Q.birdBar__closure0(t1));
        t4 = H.TakeIterable_TakeIterable(t4, 15, H.getRuntimeTypeArgument(t4, "IterableBase", 0));
        filterlist = P.List_List$from(t4, true, H.getRuntimeTypeArgument(t4, "IterableBase", 0));
      }
      t4 = J.getInterceptor$asx(filterlist);
      if (t4.get$isNotEmpty(filterlist)) {
        t5 = this.box_0;
        t5.brdList_1 = Q.birdChooseList(t4.take$1(filterlist, 15).toList$0(0), t3, t5.features_0);
        J.set$children$x(document.querySelector("#rest"), [t5.brdList_1]);
        t2.get$classes(t1).remove$1(0, "error");
      } else
        t2.get$classes(t1).add$1(0, "error");
    }
  },
  birdBar__closure: {
    "^": "Closure:14;",
    call$1: function(bird) {
      var t1 = $.get$descrips().descs;
      return !H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(t1), [H.getTypeArgumentByIndex(t1, 0)])._map.containsKey$1(bird);
    }
  },
  birdBar__closure0: {
    "^": "Closure:14;inp_3",
    call$1: function(bird) {
      return C.JSString_methods.contains$1(J.toLowerCase$0$s(J.get$name$x(bird)), J.toLowerCase$0$s(J.get$value$x(this.inp_3)));
    }
  },
  descInput_closure: {
    "^": "Closure:14;",
  ...
  getBird_closure: {
    "^": "Closure:14;box_0,d_1,morph_2",
    call$1: function(bird) {
      if (J.$eq(bird.get$sci(), this.d_1.$index(0, "sci")) && J.$eq(bird.morph, this.morph_2))
        this.box_0.brd_0 = bird;
    }
  },
  putDesc_closure: {
    "^": "Closure:14;desc_0,idMap_1",
    call$1: function(group) {
      var t1 = this.desc_0;
      J.forEach$1$ax(t1.features.$index(0, group).get$keys(), new Q.putDesc__closure(t1, this.idMap_1, group));
    }
  },
  putDesc__closure: {
    "^": "Closure:14;desc_2,idMap_3,group_4",
    call$1: function(attr) {
      var upMap, t1;
      upMap = this.idMap_3;
      t1 = this.group_4;
      upMap.$indexSet(0, "group", t1);
      upMap.$indexSet(0, "attr", attr);
      upMap.$indexSet(0, "value", J.$index$asx(this.desc_2.features.$index(0, t1), attr));
      W.HttpRequest_postFormData("../birdDescUpload", upMap, null, null, null, null);
    }
  },
  updateDesc_closure: {
    "^": "Closure:14;b_0,desc_1",
    call$1: function(e) {
      return Q.putDesc(this.b_0, this.desc_1);
    }
  },
  birdSort_closure: {
    "^": "Closure:13;features_0",
    call$2: function(x, y) {
      var t1 = this.features_0;
      return C.JSNumber_methods.compareTo$1(Q.matchBird(y, t1), Q.matchBird(x, t1));
    }
  },
  closure: {
    "^": "Closure:14;",
    call$1: function(f) {
      return Q.BirdId$fromMap(f);
    }
  },
  main_closure: {
    "^": "Closure:14;",
    call$1: function(s) {
      $.birdrace = J.$index$asx(J.$index$asx(C.JsonCodec_null_null.decode$1(s), 0), "abundance");
    }
  },
  main_closure0: {
    "^": "Closure:14;",
    call$1: function(p) {
      W.HttpRequest_getString("../wikidata", null, null).then$1(new Q.main__closure()).then$1(new Q.main__closure0());
    }
  },
  main__closure: {
    "^": "Closure:14;",
    call$1: function(s) {
      var t1 = C.JsonCodec_null_null.decode$1(s);
      $.wikiData = t1;
      $.birdIds = J.map$1$ax(t1, new Q.main___closure0()).toList$0(0);
      t1 = new Q.Features(null);
      t1.features = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      Q.birdSort(t1);
    }
  },
  main___closure0: {
  ...
  main__closure0: {
    "^": "Closure:14;",
    call$1: function(e) {
      W.HttpRequest_getString("../birdDescs", null, null).then$1(new Q.main___closure());
    }
  },
  main___closure: {
    "^": "Closure:14;",
    call$1: function(s) {
      J.forEach$1$ax(C.JsonCodec_null_null.decode$1(s), new Q.main____closure());
      Q.debugOut("Descriptions" + $.get$descrips().display$0());
      Q.repQueries();
    }
  },
  main____closure: {
    ...
    call$1: function(d) {
      ...
      t1 = $.get$descrips();
      t2 = Q.getBird(d);
      t3 = J.getInterceptor$asx(d);
      t4 = t3.$index(d, "group");
      t5 = t3.$index(d, "attr");
      t3 = t3.$index(d, "value");
      if (t1.descs.containsKey$1(t2))
        J.add$3$ax(t1.descs.$index(0, t2), t4, t5, t3);
      else {
        t6 = t1.descs;
        t7 = new Q.Features(null);
        t7.features = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
        t7.add$3(0, t4, t5, t3);
        t6.$indexSet(0, t2, t7);
      }
      Q.debugOut("...updated: " + P.Maps_mapToString(t1.descs));
      return;
    }
  }
},
...
["dart.async", "dart:async", , P, {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 17, 5]
  },
  _Future: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  HttpRequest_postFormData: function(url, data, onProgress, requestHeaders, responseType, withCredentials) {
    ...
    requestHeaders = H.setRuntimeTypeInfo(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [J.JSString, J.JSString]);
  ...
  InputElement: {
    "^": "HtmlElement;checked=,height},max},min},name%,size},src},type},value%,width}",
    $isElement: true,
    "%": "HTMLInputElement"
  },
  KeygenElement: {
  ...
  _ChildrenElementList: {
    ...
    addAll$1: function(_, iterable) {
      var t1, t2;
      for (t1 = new H.ListIterator(iterable, iterable.length, 0, null), t2 = this._element; t1.moveNext$0();)
...
Q.BirdId.$isBirdId = true;
Q.BirdId.$isObject = true;
...
Isolate.$lazy($, "reported", "reported", "get$reported", function() {
  var t1 = new Q.Features(null);
  t1.features = H.fillLiteralMap(["size", H.fillLiteralMap(["size", "25"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  return t1;
});
Isolate.$lazy($, "descrips", "descrips", "get$descrips", function() {
  var t1 = new Q.Descriptions(null);
  t1.descs = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  return t1;
});
Isolate.$lazy($, "mainColours", "mainColours", "get$mainColours", function() {
  return ["back", "head", "breast"];
});
Isolate.$lazy($, "binAttr", "binAttr", "get$binAttr", function() {
  return H.fillLiteralMap(["Tail", ["long", "forked", "upright", "fan"], "Beak", ["hooked", "long", "curved"], "Legs", ["long"], "Feet", ["webbed", "spread-out"], "Crest/cap", ["crest", "cap"]], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
Isolate.$lazy($, "behAttr", "behAttr", "get$behAttr", function() {
  return H.fillLiteralMap(["Seen", ["flying overhead", "on the ground", "on a branch", "swimming"], "Habitat", ["grassland/field", "forested", "near waterbody", "marshy", "hilly", "urban"], "Flight", ["gliding", "catching insects", "swift"]], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
Isolate.$lazy($, "otherColours", "otherColours", "get$otherColours", function() {
  return ["leg", "beak", "neck", "tail", "wing-underside", "wing-tips"];
});
Isolate.$lazy($, "descFeatures", "descFeatures", "get$descFeatures", function() {
  var t1 = new Q.Features(null);
  t1.features = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  return t1;
});
Isolate.$lazy($, "birdrace", "birdrace", "get$birdrace", function() {
  return H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
Isolate.$lazy($, "wikiData", "wikiData", "get$wikiData", function() {
  return C.JsonCodec_null_null.decode$1($.wikiSampleText);
});
Isolate.$lazy($, "birdIds", "birdIds", "get$birdIds", function() {
  return J.map$1$ax($.get$wikiData(), new Q.closure()).toList$0(0);
});
...
{func: "Element__BirdId", ret: W.Element, args: [Q.BirdId]},
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner((function(a){H.startRootIsolate(Q.main$closure(),a)}), []);
  } else {
    (function(a){H.startRootIsolate(Q.main$closure(),a)})([]);
  }
});
// END invoke [main].
function init() {
...
function dart_precompiled($collectedClasses) {
  ...
  Features.prototype.get$features = function() {
    return this.features;
  };
  function Descriptions(descs) {
    this.descs = descs;
  }
  Descriptions.builtin$cls = "Descriptions";
  if (!"name" in Descriptions)
    Descriptions.name = "Descriptions";
  $desc = $collectedClasses.Descriptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Descriptions.prototype = $desc;
  function Descriptions_display_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Descriptions_display_closure.builtin$cls = "Descriptions_display_closure";
  if (!"name" in Descriptions_display_closure)
    Descriptions_display_closure.name = "Descriptions_display_closure";
  $desc = $collectedClasses.Descriptions_display_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Descriptions_display_closure.prototype = $desc;
  function BirdId(name, sci, url, img, morph) {
    this.name = name;
    this.sci = sci;
    this.url = url;
    this.img = img;
  ...
  BirdId.builtin$cls = "BirdId";
  if (!"name" in BirdId)
    BirdId.name = "BirdId";
  $desc = $collectedClasses.BirdId;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BirdId.prototype = $desc;
  BirdId.prototype.get$name = function(receiver) {
    return this.name;
  };
  BirdId.prototype.get$sci = function() {
    return this.sci;
  };
  BirdId.prototype.get$img = function(receiver) {
    return this.img;
  };
  BirdId.prototype.set$morph = function(v) {
    return this.morph = v;
  };
  function sizePrompt_closure(numval_0, modelSizes_1) {
    this.numval_0 = numval_0;
    this.modelSizes_1 = modelSizes_1;
  }
  sizePrompt_closure.builtin$cls = "sizePrompt_closure";
  if (!"name" in sizePrompt_closure)
    sizePrompt_closure.name = "sizePrompt_closure";
  $desc = $collectedClasses.sizePrompt_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sizePrompt_closure.prototype = $desc;
  function sizeInput_closure(features_0, rep_1, prompt_2, slider_3) {
    this.features_0 = features_0;
    this.rep_1 = rep_1;
    this.prompt_2 = prompt_2;
    this.slider_3 = slider_3;
  }
  sizeInput_closure.builtin$cls = "sizeInput_closure";
  if (!"name" in sizeInput_closure)
    sizeInput_closure.name = "sizeInput_closure";
  $desc = $collectedClasses.sizeInput_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sizeInput_closure.prototype = $desc;
  function sizeInput_closure0(features_4, rep_5, prompt_6, slider_7, txtsz_8) {
    this.features_4 = features_4;
    this.rep_5 = rep_5;
    this.prompt_6 = prompt_6;
    this.slider_7 = slider_7;
    this.txtsz_8 = txtsz_8;
  }
  sizeInput_closure0.builtin$cls = "sizeInput_closure0";
  if (!"name" in sizeInput_closure0)
    sizeInput_closure0.name = "sizeInput_closure0";
  $desc = $collectedClasses.sizeInput_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sizeInput_closure0.prototype = $desc;
  function RGB(R, G, B) {
    this.R = R;
    this.G = G;
    this.B = B;
  ...
  if (!"name" in RGB)
    RGB.name = "RGB";
  $desc = $collectedClasses.RGB;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RGB.prototype = $desc;
  function checkboxChoose_closure(group_0, name_1, features_2, rep_3, inp_4) {
    this.group_0 = group_0;
    this.name_1 = name_1;
    this.features_2 = features_2;
    this.rep_3 = rep_3;
    this.inp_4 = inp_4;
  }
  checkboxChoose_closure.builtin$cls = "checkboxChoose_closure";
  if (!"name" in checkboxChoose_closure)
    checkboxChoose_closure.name = "checkboxChoose_closure";
  $desc = $collectedClasses.checkboxChoose_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  checkboxChoose_closure.prototype = $desc;
  function colourChoose_closure(name_0, features_1, rep_2, inp_3) {
    this.name_0 = name_0;
    this.features_1 = features_1;
    this.rep_2 = rep_2;
    this.inp_3 = inp_3;
  }
  colourChoose_closure.builtin$cls = "colourChoose_closure";
  if (!"name" in colourChoose_closure)
    colourChoose_closure.name = "colourChoose_closure";
  $desc = $collectedClasses.colourChoose_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  colourChoose_closure.prototype = $desc;
  function checkboxList_closure(group_0, features_1, rep_2, ulist_3) {
    this.group_0 = group_0;
    this.features_1 = features_1;
    this.rep_2 = rep_2;
    this.ulist_3 = ulist_3;
  }
  checkboxList_closure.builtin$cls = "checkboxList_closure";
  if (!"name" in checkboxList_closure)
    checkboxList_closure.name = "checkboxList_closure";
  $desc = $collectedClasses.checkboxList_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  checkboxList_closure.prototype = $desc;
  function colourquerySelector_closure(features_0, rep_1) {
    this.features_0 = features_0;
    this.rep_1 = rep_1;
  }
  colourquerySelector_closure.builtin$cls = "colourquerySelector_closure";
  if (!"name" in colourquerySelector_closure)
    colourquerySelector_closure.name = "colourquerySelector_closure";
  $desc = $collectedClasses.colourquerySelector_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  colourquerySelector_closure.prototype = $desc;
  function binAttributes_closure(features_0, rep_1) {
    this.features_0 = features_0;
    this.rep_1 = rep_1;
  }
  binAttributes_closure.builtin$cls = "binAttributes_closure";
  if (!"name" in binAttributes_closure)
    binAttributes_closure.name = "binAttributes_closure";
  $desc = $collectedClasses.binAttributes_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  binAttributes_closure.prototype = $desc;
  function behAttributes_closure(features_0, rep_1) {
    this.features_0 = features_0;
    this.rep_1 = rep_1;
  }
  behAttributes_closure.builtin$cls = "behAttributes_closure";
  if (!"name" in behAttributes_closure)
    behAttributes_closure.name = "behAttributes_closure";
  $desc = $collectedClasses.behAttributes_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  behAttributes_closure.prototype = $desc;
  function behDescAttributes_closure(features_0) {
    this.features_0 = features_0;
  }
  behDescAttributes_closure.builtin$cls = "behDescAttributes_closure";
  if (!"name" in behDescAttributes_closure)
    behDescAttributes_closure.name = "behDescAttributes_closure";
  $desc = $collectedClasses.behDescAttributes_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  behDescAttributes_closure.prototype = $desc;
  function behDescAttributes__closure(features_1, group_2, ul_3) {
    this.features_1 = features_1;
    this.group_2 = group_2;
    this.ul_3 = ul_3;
  }
  behDescAttributes__closure.builtin$cls = "behDescAttributes__closure";
  if (!"name" in behDescAttributes__closure)
    behDescAttributes__closure.name = "behDescAttributes__closure";
  $desc = $collectedClasses.behDescAttributes__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  behDescAttributes__closure.prototype = $desc;
  function behDescAttributes___closure(features_4, group_5, attr_6, choiceButtons_7) {
    this.features_4 = features_4;
    this.group_5 = group_5;
    this.attr_6 = attr_6;
    this.choiceButtons_7 = choiceButtons_7;
  }
  behDescAttributes___closure.builtin$cls = "behDescAttributes___closure";
  if (!"name" in behDescAttributes___closure)
    behDescAttributes___closure.name = "behDescAttributes___closure";
  $desc = $collectedClasses.behDescAttributes___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  behDescAttributes___closure.prototype = $desc;
  function behDescAttributes____closure(features_8, group_9, attr_10, choice_11) {
    this.features_8 = features_8;
    this.group_9 = group_9;
    this.attr_10 = attr_10;
    this.choice_11 = choice_11;
  }
  behDescAttributes____closure.builtin$cls = "behDescAttributes____closure";
  if (!"name" in behDescAttributes____closure)
    behDescAttributes____closure.name = "behDescAttributes____closure";
  $desc = $collectedClasses.behDescAttributes____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  behDescAttributes____closure.prototype = $desc;
  function repQueries_closure() {
  }
  repQueries_closure.builtin$cls = "repQueries_closure";
  if (!"name" in repQueries_closure)
    repQueries_closure.name = "repQueries_closure";
  $desc = $collectedClasses.repQueries_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  repQueries_closure.prototype = $desc;
  function descQueries_closure() {
  }
  descQueries_closure.builtin$cls = "descQueries_closure";
  if (!"name" in descQueries_closure)
    descQueries_closure.name = "descQueries_closure";
  $desc = $collectedClasses.descQueries_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  descQueries_closure.prototype = $desc;
  function descQueries_closure0(morphInput_0) {
    this.morphInput_0 = morphInput_0;
  }
  descQueries_closure0.builtin$cls = "descQueries_closure0";
  if (!"name" in descQueries_closure0)
    descQueries_closure0.name = "descQueries_closure0";
  $desc = $collectedClasses.descQueries_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  descQueries_closure0.prototype = $desc;
  function descQueries_closure1(features_1) {
    this.features_1 = features_1;
  }
  descQueries_closure1.builtin$cls = "descQueries_closure1";
  if (!"name" in descQueries_closure1)
    descQueries_closure1.name = "descQueries_closure1";
  $desc = $collectedClasses.descQueries_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  descQueries_closure1.prototype = $desc;
  function birdChooseList_closure(fullbirdlist_0, features_1, div_2) {
    this.fullbirdlist_0 = fullbirdlist_0;
    this.features_1 = features_1;
    this.div_2 = div_2;
  }
  birdChooseList_closure.builtin$cls = "birdChooseList_closure";
  if (!"name" in birdChooseList_closure)
    birdChooseList_closure.name = "birdChooseList_closure";
  $desc = $collectedClasses.birdChooseList_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdChooseList_closure.prototype = $desc;
  function birdChooseList__closure(fullbirdlist_3, features_4, b_5) {
    this.fullbirdlist_3 = fullbirdlist_3;
    this.features_4 = features_4;
    this.b_5 = b_5;
  }
  birdChooseList__closure.builtin$cls = "birdChooseList__closure";
  if (!"name" in birdChooseList__closure)
    birdChooseList__closure.name = "birdChooseList__closure";
  $desc = $collectedClasses.birdChooseList__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdChooseList__closure.prototype = $desc;
  function birdBar_closure(box_0, fullbirdlist_1, inp_2) {
    this.box_0 = box_0;
    this.fullbirdlist_1 = fullbirdlist_1;
    this.inp_2 = inp_2;
  }
  birdBar_closure.builtin$cls = "birdBar_closure";
  if (!"name" in birdBar_closure)
    birdBar_closure.name = "birdBar_closure";
  $desc = $collectedClasses.birdBar_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdBar_closure.prototype = $desc;
  function birdBar__closure() {
  }
  birdBar__closure.builtin$cls = "birdBar__closure";
  if (!"name" in birdBar__closure)
    birdBar__closure.name = "birdBar__closure";
  $desc = $collectedClasses.birdBar__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdBar__closure.prototype = $desc;
  function birdBar__closure0(inp_3) {
    this.inp_3 = inp_3;
  }
  birdBar__closure0.builtin$cls = "birdBar__closure0";
  if (!"name" in birdBar__closure0)
    birdBar__closure0.name = "birdBar__closure0";
  $desc = $collectedClasses.birdBar__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdBar__closure0.prototype = $desc;
  function descInput_closure() {
  }
  descInput_closure.builtin$cls = "descInput_closure";
  if (!"name" in descInput_closure)
    descInput_closure.name = "descInput_closure";
  $desc = $collectedClasses.descInput_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  descInput_closure.prototype = $desc;
  function getBird_closure(box_0, d_1, morph_2) {
    this.box_0 = box_0;
    this.d_1 = d_1;
    this.morph_2 = morph_2;
  }
  getBird_closure.builtin$cls = "getBird_closure";
  if (!"name" in getBird_closure)
    getBird_closure.name = "getBird_closure";
  $desc = $collectedClasses.getBird_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getBird_closure.prototype = $desc;
  function putDesc_closure(desc_0, idMap_1) {
    this.desc_0 = desc_0;
    this.idMap_1 = idMap_1;
  }
  putDesc_closure.builtin$cls = "putDesc_closure";
  if (!"name" in putDesc_closure)
    putDesc_closure.name = "putDesc_closure";
  $desc = $collectedClasses.putDesc_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  putDesc_closure.prototype = $desc;
  function putDesc__closure(desc_2, idMap_3, group_4) {
    this.desc_2 = desc_2;
    this.idMap_3 = idMap_3;
    this.group_4 = group_4;
  }
  putDesc__closure.builtin$cls = "putDesc__closure";
  if (!"name" in putDesc__closure)
    putDesc__closure.name = "putDesc__closure";
  $desc = $collectedClasses.putDesc__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  putDesc__closure.prototype = $desc;
  function updateDesc_closure(b_0, desc_1) {
    this.b_0 = b_0;
    this.desc_1 = desc_1;
  }
  updateDesc_closure.builtin$cls = "updateDesc_closure";
  if (!"name" in updateDesc_closure)
    updateDesc_closure.name = "updateDesc_closure";
  $desc = $collectedClasses.updateDesc_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  updateDesc_closure.prototype = $desc;
  function birdSort_closure(features_0) {
    this.features_0 = features_0;
  }
  birdSort_closure.builtin$cls = "birdSort_closure";
  if (!"name" in birdSort_closure)
    birdSort_closure.name = "birdSort_closure";
  $desc = $collectedClasses.birdSort_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  birdSort_closure.prototype = $desc;
  function closure() {
  }
  closure.builtin$cls = "closure";
  if (!"name" in closure)
