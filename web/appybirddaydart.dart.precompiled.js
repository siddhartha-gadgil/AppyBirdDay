// Generated by dart2js, the Dart to JavaScript compiler version: 1.1.0-dev.5.6.
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  ReceivePortImpl: {
    ...
    close$0: [function(_) {
      ...
      t1 = this._controller;
      t1.close$0(t1);
    }, "call$0" /* tearOffInfo */, "get$close", 0, 0, 2],
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  }, "call$1" /* tearOffInfo */, "Primitives__throwFormatException$closure", 2, 0, 0],
...
["", "appybirddaydart.dart", , Q, {
  ...
  debugOut: function(deb) {
    document.querySelector("#debugOut").textContent = J.$add$ns(document.querySelector("#debugOut").textContent, deb) + " ;; ";
  },
  sizePrompt: function(value) {
    ...
    closest = ord[0];
    return "  " + H.S(value) + " cm (~ " + H.S(closest) + "=" + H.S(modelSizes.$index(modelSizes, closest)) + "cm)";
  },
  sizeInput: function(features, rep) {
    var $prompt, slider, t1, t2, span;
    ...
    if (features.features.containsKey$1("size")) {
      t2 = features.features;
      t2 = t2.$index(t2, "size").containsKey$1("size") === true;
    } else
      t2 = false;
    if (t2) {
      t2 = features.features;
      t1.set$value(slider, J.$index$asx(t2.$index(t2, "size"), "size"));
    }
  ...
  binMatch: function(group, attr, rep, desc) {
    var t1;
    if (rep.features.containsKey$1(group)) {
      t1 = rep.features;
      t1 = t1.$index(t1, group).containsKey$1(attr) === true;
    } else
      t1 = false;
    if (t1)
      if (desc.has$2(group, attr)) {
        t1 = rep.features;
        t1 = J.toLowerCase$0$s(J.$index$asx(t1.$index(t1, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "true";
      } else
        t1 = false;
    else
      t1 = false;
  ...
  behMatch: function(group, attr, rep, desc) {
    ...
    if (rep.features.containsKey$1(group)) {
      ...
      t1 = false;
    if (t1 && desc.has$2(group, attr)) {
      t1 = rep.features;
      if (J.toLowerCase$0$s(J.$index$asx(t1.$index(t1, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "often")
        return $.behCommonSeen;
      t1 = rep.features;
      if (J.toLowerCase$0$s(J.$index$asx(t1.$index(t1, group), attr)) === "true" && J.toLowerCase$0$s(desc.get$2(group, attr)) === "rarely")
        return $.behRareSeen;
    }
    return 0;
  },
  colMatchSum: function(rep, desc) {
    ...
    for (t1 = new H.ListIterator($.get$mainColours(), 3, 0, null), sum = 0; t1.moveNext$0();) {
      ...
      if (rep.features.containsKey$1(group)) {
        t2 = rep.features;
        t2 = t2.$index(t2, group).containsKey$1("colour") === true;
      } else
        t2 = false;
      if (t2 && desc.has$2(group, "colour")) {
        t2 = $.colWt;
        t3 = $.colPar;
        t4 = rep.features;
        t4 = J.$index$asx(t4.$index(t4, group), "colour");
  ...
  behMatchSum: function(rep, desc) {
    ...
    for (t1 = $.get$behAttr().get$keys()._map, t2 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first, sum = 0; t2.moveNext$0();) {
      ...
      for (t1 = $.get$behAttr(), t1 = J.get$iterator$ax(t1.$index(t1, group)); t1.moveNext$0();) {
  ...
  binMatchSum: function(rep, desc) {
    ...
    for (t1 = $.get$binAttr().get$keys()._map, t2 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first, sum = 0; t2.moveNext$0();) {
      group = t2._collection$_current;
      for (t1 = $.get$binAttr(), t1 = J.get$iterator$ax(t1.$index(t1, group)); t1.moveNext$0();)
  ...
  checkboxChoose: function(group, $name, features, rep) {
    ...
    if (features.features.containsKey$1(group)) {
      t1 = features.features;
      t1 = t1.$index(t1, group).containsKey$1($name) === true;
    } else
      t1 = false;
    if (t1) {
      t1 = features.features;
      J.set$value$x(inp, J.$index$asx(t1.$index(t1, group), $name));
    }
    inp.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(inp, C.EventStreamProvider_change._eventType, false), [null]);
    ...
    t1 = J.get$children$x(par);
    t1.add$1(t1, inp);
    t1 = J.get$children$x(item);
    t1.add$1(t1, par);
    return item;
  },
  colourChoose: function($name, features, rep) {
    ...
    if (features.features.containsKey$1("colour")) {
      t1 = features.features;
      t1 = t1.$index(t1, "colour").containsKey$1($name) === true;
    } else
      t1 = false;
    if (t1) {
      t1 = features.features;
      J.set$value$x(inp, J.$index$asx(t1.$index(t1, "colour"), $name));
    }
    J.set$type$x(inp, "color");
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(inp, C.EventStreamProvider_change._eventType, false), [null]);
  ...
  repUpdate: function() {
    var t1, t2, bestBirds;
    t1 = document.querySelector("#rep");
    t2 = $.get$reported().features;
    t1.textContent = t2.toString$0(t2) + "\n" + $.get$descrips().display$0();
    bestBirds = J.take$1$ax($.get$birdIds(), 12);
    t2 = document.querySelector("#best");
    t1 = H.setRuntimeTypeInfo(new H.MappedListIterable(bestBirds, Q.birdBox$closure()), [null, null]);
    J.set$children$x(t2, t1.toList$0(t1));
  },
  colourquerySelector: function(colours, features, rep) {
    var colourIter = H.setRuntimeTypeInfo(new H.MappedListIterable(colours, new Q.colourquerySelector_closure(features, rep)), [null, null]);
    return colourIter.toList$0(colourIter);
  },
  birdBox: [function(bird) {
    ...
    return div;
  }, "call$1" /* tearOffInfo */, "birdBox$closure", 2, 0, 1],
  binAttributes: function(features, rep) {
    var t1;
    J.set$children$x(document.querySelector("#bin_attr"), []);
    t1 = $.get$binAttr().get$keys();
    t1.forEach$1(t1, new Q.binAttributes_closure(features, rep));
  },
  behAttributes: function(features, rep) {
    var t1;
    J.set$children$x(document.querySelector("#beh_attr"), []);
    t1 = $.get$behAttr().get$keys();
    t1.forEach$1(t1, new Q.behAttributes_closure(features, rep));
  },
  behDescAttributes: function(features) {
    var t1;
    J.set$children$x(document.querySelector("#beh_attr"), []);
    t1 = $.get$behAttr().get$keys();
    t1.forEach$1(t1, new Q.behDescAttributes_closure(features));
  },
  repQueries: function() {
    var updateButton, t1, bestBirds, t2;
    ...
    updateButton.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(updateButton, C.EventStreamProvider_click._eventType, false), [null]);
    ...
    bestBirds = J.take$1$ax($.get$birdIds(), 12);
    t1 = document.querySelector("#best");
    t2 = H.setRuntimeTypeInfo(new H.MappedListIterable(bestBirds, Q.birdBox$closure()), [null, null]);
    J.set$children$x(t1, t2.toList$0(t2));
  ...
  descQueries: function(features) {
    var identButton, t1, t2, morph, morphInput, submitButton;
    ...
    identButton.toString;
    t1 = C.EventStreamProvider_click._eventType;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(identButton, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.descQueries_closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    J.set$children$x(document.querySelector("#topbar"), [identButton]);
    morph = document.createElement("span", null);
    morph.textContent = "Morph";
    t2 = J.get$classes$x(morph);
    t2.add$1(t2, "inp");
    morphInput = W.InputElement_InputElement(null);
    morphInput.textContent = "morph";
    t2 = J.getInterceptor$x(morphInput);
    t2.set$size(morphInput, 10);
    t2 = t2.get$classes(morphInput);
    t2.add$1(t2, "inp");
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(morphInput, C.EventStreamProvider_change._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.descQueries_closure0(morphInput)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    submitButton = document.createElement("button", null);
    submitButton.textContent = "save description";
    t2 = J.get$classes$x(submitButton);
    t2.add$1(t2, "input");
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(submitButton, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.descQueries_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$children$x(document.querySelector("#queryfoot"), [morph, morphInput, submitButton]);
  },
  birdChooseList: function(birdlst, fullbirdlist) {
    var div, t1;
    div = document.createElement("div", null);
    t1 = H.SubListIterable$(birdlst, 0, 15, null);
    t1.forEach$1(t1, new Q.birdChooseList_closure(fullbirdlist, div));
    return div;
  },
  birdBar: function(firstbird, birdlist, fullbirdlist) {
    var t1, inp, t2;
    t1 = {};
    $.birdChosen = firstbird;
    inp = W.InputElement_InputElement(null);
    inp.textContent = "search:";
    J.set$type$x(inp, "search");
    t1.brdList_0 = Q.birdChooseList(birdlist, fullbirdlist);
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(inp, C.EventStreamProvider_input._eventType, false), [null]);
    ...
    J.set$children$x(document.querySelector("#rest"), [t1.brdList_0]);
  },
  descInput: function(birds) {
    ...
    Q.birdBar(bestbirds[0], bestbirds, birds);
  },
  matchBird: function(birdId, rep) {
    var t1, t2, t3, t4, t5, out;
    if ($.get$descrips().descs.containsKey$1(birdId)) {
      t1 = $.get$descrips().descs;
      t1 = t1.$index(t1, birdId);
      t2 = Q.binMatchSum(rep, t1);
      t3 = Q.behMatchSum(rep, t1);
      t4 = Q.colMatchSum(rep, t1);
      if (t1.has$2("size", "size")) {
        t1 = t1.features;
        t1 = H.Primitives_parseInt(J.$index$asx(t1.$index(t1, "size"), "size"), null, null);
        t5 = rep.features;
        t5 = H.Primitives_parseInt(J.$index$asx(t5.$index(t5, "size"), "size"), null, null);
        if (typeof t1 !== "number")
          return t1.$div();
        if (typeof t5 !== "number")
          return H.iae(t5);
        t1 = Math.abs(Math.log(t1 / t5));
        t5 = $.sizeWt;
        if (typeof t5 !== "number")
          return H.iae(t5);
        out = t1 * t5;
  ...
  main: [function() {
    Q.debugOut("Hello\n");
    var t1 = document.querySelector("#cleartrace");
    t1.toString;
    ...
    if (!$.local) {
      W.HttpRequest_getString("../wikidata", null, null).then$1(new Q.main_closure0());
      W.HttpRequest_getString("../abundances", null, null).then$1(new Q.main_closure1());
      Q.repQueries();
    }
  ...
  Features: {
    ...
    add$3: function(_, group, attr, value) {
      ...
      t2 = this.features;
      if (t1)
        J.$indexSet$ax(t2.$index(t2, group), attr, value);
      else {
        t2.$indexSet(t2, group, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t1 = this.features;
        J.$indexSet$ax(t1.$index(t1, group), attr, value);
      }
    },
    get$2: function(group, attr) {
      var t1 = this.features;
      return J.$index$asx(t1.$index(t1, group), attr);
    },
    has$2: function(group, attr) {
      var t1;
      if (this.features.containsKey$1(group)) {
        t1 = this.features;
        t1 = t1.$index(t1, group).containsKey$1(attr) === true;
      } else
        t1 = false;
  ...
  Descriptions: {
    ...
    display$0: function() {
      ...
      t2.forEach$1(t2, new Q.Descriptions_display_closure(t1, this));
      return t1.dsp_0 + "}";
    }
  },
  Descriptions_display_closure: {
    ...
    call$1: function(birdId) {
      ...
      t1 = this.box_0;
      t2 = t1.dsp_0;
      t3 = H.S(J.get$name$x(birdId)) + " : ";
      t4 = this.this_1.descs;
      t4 = t4.$index(t4, birdId).get$features();
      dsp = t2 + (t3 + t4.toString$0(t4) + ", ");
      t1.dsp_0 = dsp;
      return dsp;
    }
  },
  ...
  sizePrompt_closure: {
    ...
    call$2: function(x, y) {
      ...
      t2 = this.numval_0;
      return C.JSNumber_methods.compareTo$1(J.abs$0$n(J.$sub$n(t1.$index(t1, x), t2)), J.abs$0$n(J.$sub$n(t1.$index(t1, y), t2)));
    }
  },
  sizeInput_closure: {
  ...
  checkboxChoose_closure: {
    ...
    call$1: function(e) {
      ...
      t1 = this.features_2;
      t1.add$3(t1, this.group_0, this.name_1, value);
      if (this.rep_3) {
        Q.birdSort(t1);
        Q.repUpdate();
      }
  ...
  colourChoose_closure: {
    ...
    call$1: function(e) {
      ...
      t1.add$3(t1, "colour", this.name_0, J.get$value$x(this.inp_3));
      if (this.rep_2) {
        Q.birdSort(t1);
        Q.repUpdate();
      }
  ...
  checkboxList_closure: {
    ...
    call$1: function($name) {
      var t1 = J.get$children$x(this.ulist_3);
      t1.add$1(t1, Q.checkboxChoose(this.group_0, $name, this.features_1, this.rep_2));
    }
  },
  ...
  binAttributes_closure: {
    ...
    call$1: function(group) {
      ...
      t2 = $.get$binAttr();
      t1.add$1(t1, Q.checkboxList(group, t2.$index(t2, group), this.features_0, this.rep_1));
      t2 = J.get$children$x(document.querySelector("#bin_attr"));
      t2.add$1(t2, div);
    }
  },
  behAttributes_closure: {
    ...
    call$1: function(group) {
      ...
      t2 = $.get$behAttr();
      t1.add$1(t1, Q.checkboxList(group, t2.$index(t2, group), this.features_0, this.rep_1));
      t2 = J.get$children$x(document.querySelector("#beh_attr"));
      t2.add$1(t2, div);
    }
  },
  behDescAttributes_closure: {
    ...
    call$1: function(group) {
      ...
      t1.add$1(t1, ul);
      t1 = $.get$behAttr();
      J.forEach$1$ax(t1.$index(t1, group), new Q.behDescAttributes__closure(this.features_0, group, ul));
      t1 = J.get$children$x(document.querySelector("#beh_attr"));
      t1.add$1(t1, div);
    }
  },
  behDescAttributes__closure: {
    ...
    call$1: function(attr) {
      var $prompt, choiceButtons, li, t1;
  ...
  behDescAttributes___closure: {
    ...
    call$1: function(choice) {
      ...
      t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(button, C.EventStreamProvider_click._eventType, false), [null]);
      ...
      t3 = J.get$children$x(choicePrompt);
      t3.add$1(t3, button);
      t3 = J.get$children$x(this.choiceButtons_7);
      t3.add$1(t3, choicePrompt);
    }
  },
  behDescAttributes____closure: {
    "": "Closure:14;features_8,group_9,attr_10,choice_11",
    call$1: function(e) {
      var t1 = this.features_8;
      return t1.add$3(t1, this.group_9, this.attr_10, this.choice_11);
    }
  },
  repQueries_closure: {
    "": "Closure:14;",
  ...
  descQueries_closure1: {
    ...
    call$1: function(e) {
      ...
      document.querySelector("#rep").textContent = $.get$descrips().display$0();
      Q.descInput($.get$birdIds());
      return;
    }
  },
  birdChooseList_closure: {
    "": "Closure:14;fullbirdlist_0,div_1",
    call$1: function(b) {
      var el, t1;
      el = document.createElement("p", null);
      el.textContent = J.get$name$x(b);
      t1 = J.get$classes$x(el);
      t1.add$1(t1, "birdchoice");
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(el, C.EventStreamProvider_click._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.birdChooseList__closure(this.fullbirdlist_0, b)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$children$x(this.div_1);
      t1.add$1(t1, el);
    }
  },
  birdChooseList__closure: {
    "": "Closure:14;fullbirdlist_2,b_3",
    call$1: function(e) {
      var t1, t2;
      t1 = this.fullbirdlist_2;
      t2 = J.take$1$ax(t1, 15);
      return Q.birdBar(this.b_3, t2.toList$0(t2), t1);
    }
  },
  birdBar_closure: {
    ...
    call$1: function(e) {
      ...
      t5 = t4.get$isNotEmpty(filterlist);
      t1 = t2.get$classes(t1);
      if (t5) {
        t2 = t4.take$1(filterlist, 15);
        t4 = this.box_0;
        t4.brdList_0 = Q.birdChooseList(t2.toList$0(t2), t3);
        J.set$children$x(document.querySelector("#rest"), [t4.brdList_0]);
        t1.remove$1(t1, "error");
      } else
        t1.add$1(t1, "error");
    }
  },
  ...
  birdSort_closure: {
    ...
    call$2: function(x, y) {
      ...
      return Q.matchBird(x, t1) - Q.matchBird(y, t1);
    }
  },
  closure: {
    "": "Closure:14;",
  ...
  main_closure: {
    "": "Closure:14;",
    call$1: function($event) {
      document.querySelector("#debugOut").textContent = "";
      return "";
    }
  },
  main_closure0: {
    ...
    call$1: function(s) {
      ...
      $.wikiData = t1;
      t1 = J.map$1$ax(t1, new Q.main__closure());
      $.birdIds = t1.toList$0(t1);
      t1 = new Q.Features(null);
  ...
  main_closure1: {
    "": "Closure:14;",
    call$1: function(s) {
      var t1 = J.$index$asx(J.$index$asx(C.C_JsonCodec.decode$1(s), 0), "abundance");
      $.birdrace = t1;
      Q.debugOut(J.toString$0(t1));
    }
  }
},
1],
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$0" /* tearOffInfo */, "_asyncRunCallback$closure", 0, 0, 2],
  ...
  }, "call$1" /* tearOffInfo */, "_nullDataHandler$closure", 2, 0, 3],
  ...
  }, null, "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "_nullErrorHandler$closure", 2, 2, 4, 5],
  _nullDoneHandler: [function() {
    return;
  }, "call$0" /* tearOffInfo */, "_nullDoneHandler$closure", 0, 0, 2],
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "get$completeError", 2, 2, 17, 5],
    $as_Completer: null
  },
  _Future: {
    ...
    }, "_completeError$1", "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "get$_completeError", 2, 2, 4, 5],
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2" /* tearOffInfo */, "get$_handleError", 4, 0, 20],
    _handleDone$0: [function() {
      this._close$0();
    }, "call$0" /* tearOffInfo */, "get$_handleDone", 0, 0, 2],
...
["dart.collection", "dart:collection", , P, {
  ...
  _defaultEquals: [function(a, b) {
    return J.$eq(a, b);
  }, "call$2" /* tearOffInfo */, "_defaultEquals$closure", 4, 0, 6],
  _defaultHashCode: [function(a) {
    return J.get$hashCode$(a);
  }, "call$1" /* tearOffInfo */, "_defaultHashCode$closure", 2, 0, 7],
...
["dart.core", "dart:core", , P, {
  ...
  }, "call$2" /* tearOffInfo */, "Comparable_compare$closure", 4, 0, 8],
...
["dart.dom.html", "dart:html", , W, {
  ...
  Console: {
    ...
    }, "call$1" /* tearOffInfo */, "get$error", 2, 0, 23],
...
Isolate.$lazy($, "birdIds", "birdIds", "get$birdIds", function() {
  var t1 = J.map$1$ax($.get$wikiData(), new Q.closure());
...
function dart_precompiled($collectedClasses) {
  ...
  function birdChooseList_closure(fullbirdlist_0, div_1) {
  ...
  function birdChooseList__closure(fullbirdlist_2, b_3) {
    this.fullbirdlist_2 = fullbirdlist_2;
    this.b_3 = b_3;
  }
