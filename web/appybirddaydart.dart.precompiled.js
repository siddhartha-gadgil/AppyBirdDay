...
["appybirddaydart.dart", "appybirddaydart.dart", , Q, {
sizeInput: function(features) {
  var $prompt, slider, t1, t2, div;
  $prompt = document.createElement("p", null);
  $prompt.textContent = "Size : 25 cm";
  ...
  slider.toString;
  t1 = new W._ElementEventStreamImpl(slider, C.EventStreamProvider_change._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.sizeInput_closure(features, $prompt, slider)), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  div = document.createElement("div", null);
  J.set$children$x(div, [$prompt, slider]);
  return div;
},

checkboxChoose: function(group, $name, features) {
  var item, par, inp, t1, t2;
  item = document.createElement("li", null);
  par = document.createElement("p", null);
  par.textContent = J.$add$ns($name, ": ");
  inp = W.InputElement_InputElement("checkbox");
  inp.toString;
  t1 = new W._ElementEventStreamImpl(inp, C.EventStreamProvider_change._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.checkboxChoose_closure(group, $name, features, inp)), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = J.get$children$x(par);
  t2.add$1(t2, inp);
  t2 = J.get$children$x(item);
  t2.add$1(t2, par);
  return item;
},

colourChoose: function($name, features) {
  var item, par, inp, t1, t2;
  item = document.createElement("li", null);
  par = document.createElement("p", null);
  par.textContent = J.$add$ns($name, ": ");
  ...
  t1 = new W._ElementEventStreamImpl(inp, C.EventStreamProvider_change._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.colourChoose_closure($name, features, inp)), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = J.get$children$x(par);
  t2.add$1(t2, inp);
...
checkboxList: function(group, names, features) {
  var ulist = document.createElement("ul", null);
  J.forEach$1$ax(names, new Q.checkboxList_closure(group, features, ulist));
  return ulist;
},

colourquerySelector: function(colours, features) {
  var colourIter = new H.MappedListIterable(colours, new Q.colourquerySelector_closure(features));
  H.setRuntimeTypeInfo(colourIter, [null, null]);
  return colourIter.toList$0(colourIter);
},

birdDisplay: function($name, img, url) {
  var image, t1, anchor, div;
  image = W.ImageElement_ImageElement(null, null, null);
  t1 = J.getInterceptor$x(image);
  t1.set$src(image, "http:" + H.S(img));
  t1.set$height(image, 100);
  t1.set$width(image, 100);
  t1 = t1.get$classes(image);
  t1.add$1(t1, "leftmargin");
  anchor = W.AnchorElement_AnchorElement(null);
  t1 = J.getInterceptor$x(anchor);
  t1.set$href(anchor, "http://en.wikipedia.org" + H.S(url));
  anchor.textContent = $name;
  t1.set$target(anchor, "_blank");
  t1 = t1.get$classes(anchor);
  t1.add$1(t1, "leftmargin");
  div = document.createElement("div", null);
  J.set$children$x(div, [image, document.createElement("p", null), anchor, W._ElementFactoryProvider_createElement_tag("hr", null)]);
  return div;
},

birdBox: function(bird) {
  var image, t1, t2, anchor, div;
  image = W.ImageElement_ImageElement(null, null, null);
  t1 = J.getInterceptor$x(bird);
  t2 = J.getInterceptor$x(image);
  t2.set$src(image, "http:" + H.S(t1.get$img(bird)));
  t2.set$height(image, 100);
  t2.set$width(image, 100);
  t2 = t2.get$classes(image);
  t2.add$1(t2, "leftmargin");
  anchor = W.AnchorElement_AnchorElement(null);
  t2 = J.getInterceptor$x(anchor);
  t2.set$href(anchor, "http://en.wikipedia.org" + H.S(t1.get$url(bird)));
  anchor.textContent = t1.get$name(bird);
  t2.set$target(anchor, "_blank");
  t2 = t2.get$classes(anchor);
  t2.add$1(t2, "leftmargin");
  div = document.createElement("div", null);
  J.set$children$x(div, [image, document.createElement("p", null), anchor, W._ElementFactoryProvider_createElement_tag("hr", null)]);
  return div;
...
binAttributes: function(features) {
  var t1;
  J.set$children$x(document.querySelector("#bin_attr"), []);
  t1 = $.get$binAttr().get$keys();
  t1.forEach$1(t1, new Q.binAttributes_closure(features));
},

behAttributes: function(features) {
  var t1;
  J.set$children$x(document.querySelector("#beh_attr"), []);
  t1 = $.get$behAttr().get$keys();
  t1.forEach$1(t1, new Q.behAttributes_closure(features));
},

repQueries: function(features, birdIds) {
  var submitButton, t1, t2;
  J.set$children$x(document.querySelector("#size"), [Q.sizeInput(features)]);
  J.set$children$x(document.querySelector("#colour_list"), Q.colourquerySelector($.get$mainColours(), features));
  Q.binAttributes(features);
  Q.behAttributes(features);
  submitButton = document.createElement("button", null);
  submitButton.textContent = "Update Database";
  submitButton.toString;
  t1 = new W._ElementEventStreamImpl(submitButton, C.EventStreamProvider_click._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.repQueries_closure(birdIds)), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  J.set$children$x(document.querySelector("#topbar"), [submitButton]);
},
...
birdChooseList: function(birdlst, fullbirdlist) {
  ...
  J.forEach$1$ax(birdlst, new Q.birdChooseList_closure(fullbirdlist, div));
  return div;
},
...
birdBar: function(firstbird, birdlist, fullbirdlist) {
  ...
  inp.toString;
  t2 = new W._ElementEventStreamImpl(inp, C.EventStreamProvider_input._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.birdBar_closure(t1, fullbirdlist, inp)), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  document.querySelector("#besthead").textContent = "Describe:";
  J.set$children$x(document.querySelector("#best"), [Q.birdBox($.bird)]);
...
descInput: function(birds) {
  ...
  $.descFeatures = t1;
  Q.descQueries($.descFeatures);
  t1 = J.getInterceptor$ax(birds);
  t2 = t1.take$1(birds, 15);
  bestbirds = t2.toList$0(t2);
  Q.birdBar(t1.$index(birds, 0), bestbirds, birds);
},

main: function() {
  var t1, t2, w, t3;
  t1 = {};
  t1.birdrace_0 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  t1.wikiData_1 = P._parseJson($.wikiSampleText, new P.JsonDecoder(null)._reviver);
  t2 = J.map$1$ax(t1.wikiData_1, new Q.main_closure());
  t1.birdIds_2 = t2.toList$0(t2);
  document.querySelector("#rep").textContent = J.$index$asx(J.$index$asx(t1.wikiData_1, 0), "img");
  W.HttpRequest_getString("../wikidata", null, null).then$1(new Q.main_closure0(t1));
  W.HttpRequest_getString("../abundances", null, null).then$1(new Q.main_closure1(t1));
  w = J.$index$asx(t1.wikiData_1, 0);
  t2 = J.get$children$x(document.querySelector("#best"));
  t3 = J.getInterceptor$asx(w);
  t2.add$1(t2, Q.birdDisplay(t3.$index(w, "name"), t3.$index(w, "img"), t3.$index(w, "url")));
  Q.repQueries($.get$reported(), t1.birdIds_2);
},
...
BirdId: {"": "Object;name>,sci,url>,img>,morph",
...
sizeInput_closure: {"": "Closure;features_0,prompt_1,slider_2",
  call$1: function($event) {
    var size, t1, t2;
    size = J.get$value$x(this.slider_2);
    this.prompt_1.textContent = "Size : " + H.S(size) + " cm";
    t1 = this.features_0;
...
checkboxChoose_closure: {"": "Closure;group_0,name_1,features_2,inp_3",
  call$1: function(e) {
    var value, t1, t2;
    value = J.get$checked$x(this.inp_3) === true ? String(true) : String(false);
    t1 = this.features_2;
...
colourChoose_closure: {"": "Closure;name_0,features_1,inp_2",
  call$1: function(e) {
    var t1, t2;
    t1 = this.features_1;
    t1.add$3(t1, "colour", this.name_0, J.get$value$x(this.inp_2));
    t1 = document.querySelector("#rep");
    t2 = $.get$reported().features;
    t1.textContent = t2.toString$0(t2);
  }
...
checkboxList_closure: {"": "Closure;group_0,features_1,ulist_2",
  call$1: function($name) {
    var t1 = J.get$children$x(this.ulist_2);
    t1.add$1(t1, Q.checkboxChoose(this.group_0, $name, this.features_1));
  }
},

colourquerySelector_closure: {"": "Closure;features_0",
  call$1: function(col) {
    return Q.colourChoose(col, this.features_0);
  }
},

binAttributes_closure: {"": "Closure;features_0",
  call$1: function(group) {
    ...
    t2 = $.get$binAttr();
    t1.add$1(t1, Q.checkboxList(group, t2.$index(t2, group), this.features_0));
    t2 = J.get$children$x(document.querySelector("#bin_attr"));
    t2.add$1(t2, div);
  }
},

behAttributes_closure: {"": "Closure;features_0",
  call$1: function(group) {
    var div, t1, t2;
    div = document.createElement("div", null);
    t1 = J.getInterceptor$x(div);
...
repQueries_closure: {"": "Closure;birdIds_0",
  call$1: function(e) {
    return Q.descInput(this.birdIds_0);
  }
},

birdChooseList_closure: {"": "Closure;fullbirdlist_0,div_1",
  call$1: function(b) {
    var el, t1, t2;
    ...
    el.toString;
    t1 = new W._ElementEventStreamImpl(el, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.birdChooseList__closure(this.fullbirdlist_0, b)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = J.get$children$x(this.div_1);
    t2.add$1(t2, el);
  }
},

birdChooseList__closure: {"": "Closure;fullbirdlist_2,b_3",
  call$1: function(e) {
    var t1 = this.fullbirdlist_2;
    return Q.birdBar(this.b_3, t1, t1);
  }
},

birdBar_closure: {"": "Closure;box_0,fullbirdlist_1,inp_2",
  call$1: function(e) {
    var t1, t2, t3, filterlist, t4;
    t1 = this.fullbirdlist_1;
    t2 = this.inp_2;
    t3 = J.where$1$ax(t1, new Q.birdBar__closure(t2));
    t3 = H.TakeIterable_TakeIterable(t3, 15, H.getRuntimeTypeArgument(t3, "IterableBase", 0));
    filterlist = P.List_List$from(t3, true, H.getRuntimeTypeArgument(t3, "IterableBase", 0));
    t3 = J.getInterceptor$x(t2);
    if (filterlist.length !== 0) {
      t4 = this.box_0;
      t4.brdList_0 = Q.birdChooseList(filterlist, t1);
      J.set$children$x(document.querySelector("#rest"), [t4.brdList_0]);
      t2 = t3.get$classes(t2);
      t2.remove$1(t2, "error");
    } else {
      t1 = t3.get$classes(t2);
      t1.add$1(t1, "error");
    }
  }
},

birdBar__closure: {"": "Closure;inp_3",
...
main_closure0: {"": "Closure;box_0",
  call$1: function(s) {
    var t1, t2;
    t1 = this.box_0;
    t1.wikiData_1 = P._parseJson(s, new P.JsonDecoder(null)._reviver);
    t2 = J.map$1$ax(t1.wikiData_1, new Q.main__closure());
    t1.birdIds_2 = t2.toList$0(t2);
    document.querySelector("#rep").textContent = C.JSInt_methods.toString$0(J.get$length$asx(t1.birdIds_2));
    Q.repQueries($.get$reported(), t1.birdIds_2);
  }
},
...
main_closure1: {"": "Closure;box_0",
  call$1: function(s) {
    this.box_0.birdrace_0 = J.$index$asx(J.$index$asx(P._parseJson(s, new P.JsonDecoder(null)._reviver), 0), "abundance");
  }
}},
1],
...
InputElement: {"": "HtmlElement;checked=,height},max},min},name=,src},type},value%,width}", $isElement: true, $isNode: true, "%": "HTMLInputElement"},
...
MeterElement: {"": "HtmlElement;max},min},value%", "%": "HTMLMeterElement"},
...
ProgressElement: {"": "HtmlElement;max},value%", "%": "HTMLProgressElement"},
...
SvgElement: {"": "Element;",
  ...
  set$children: function(receiver, value) {
    ...
    H.setRuntimeTypeInfo(children, [W.Element]);
...
Isolate.$lazy($, "binAttr", "binAttr", "get$binAttr", function() {
  return H.fillLiteralMap(["Tail", ["long", "forked"], "Beak", ["hooked", "long"]], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
Isolate.$lazy($, "behAttr", "behAttr", "get$behAttr", function() {
  return H.fillLiteralMap(["Seen", ["flying", "on the ground", "on a branch"], "Habitat", ["dry", "forested"]], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
});
...
// Native classes
J.Interceptor["%"] = "DOMImplementation|MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedNumberList";
...
function dart_precompiled($collectedClasses) {
  ...
  BirdId.prototype.get$url = function(receiver) {
    return this.url;
  };
  BirdId.prototype.get$img = function(receiver) {
    return this.img;
  };
  function sizeInput_closure(features_0, prompt_1, slider_2) {
    this.features_0 = features_0;
    this.prompt_1 = prompt_1;
  ...
  function checkboxChoose_closure(group_0, name_1, features_2, inp_3) {
  ...
  function colourChoose_closure(name_0, features_1, inp_2) {
    this.name_0 = name_0;
  ...
  function checkboxList_closure(group_0, features_1, ulist_2) {
    this.group_0 = group_0;
    this.features_1 = features_1;
    this.ulist_2 = ulist_2;
  }
  ...
  function colourquerySelector_closure(features_0) {
    this.features_0 = features_0;
  }
  ...
  function binAttributes_closure(features_0) {
    this.features_0 = features_0;
  }
  ...
  function behAttributes_closure(features_0) {
    this.features_0 = features_0;
  }
  ...
  function repQueries_closure(birdIds_0) {
    this.birdIds_0 = birdIds_0;
  }
  ...
  function birdBar__closure(inp_3) {
    this.inp_3 = inp_3;
  }
  ...
  function _LinkedCustomHashMap(_equals, _hashCode, _validKey, _length, _strings, _nums, _rest, _first, _last, _modifications) {
